package com.mrbysco.doaflip.client.config;
...
public class FlipConfig {
	...
	public static void onLoad(final ModConfigEvent.Loading configEvent) {
		DoAFlip.LOGGER.debug("Loaded Do A Flip's config file {}", configEvent.getConfig().getFileName());
		refreshCache();
	}

	@SubscribeEvent
	public static void onFileChange(final ModConfigEvent.Reloading configEvent) {
		DoAFlip.LOGGER.warn("Do A Flip's config just got changed on the file system!");
		refreshCache();
	}
